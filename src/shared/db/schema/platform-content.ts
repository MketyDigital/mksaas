...
export const platformSiteSettings = appSchema.table(
  'platform_site_settings',
  {
    ...
    telegramHref: text('telegram_href'),
    publicAiPrompt: text('public_ai_prompt'),
    publicAiFallbackMessage: text('public_ai_fallback_message'),
    publicAiLeadCaptureEnabled: boolean('public_ai_lead_capture_enabled').notNull().default(true),
