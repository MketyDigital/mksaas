...
export const platformSiteSettings = appSchema.table(
  'platform_site_settings',
  {
    ...
    publicAssistantFallbackMessage: text('public_assistant_fallback_message'),
    publicAssistantPromptExtension: text('public_assistant_prompt_extension'),
    publicAssistantLeadCaptureEnabled: boolean('public_assistant_lead_capture_enabled').notNull().default(true),
