...
export const env = createEnv({
  server: {
    ...
    FLUTTERWAVE_CHECKOUT_BROKER_SECRET: z.string().min(32).optional(),
    KORA_SECRET_KEY: z.string().optional(),
    MKETY_MEDIA_FLUTTERWAVE_WEBHOOK_URL: z.url().optional(),
    MKETY_MEDIA_KORA_WEBHOOK_URL: z.url().optional(),
    MKETY_HOST_FLUTTERWAVE_WEBHOOK_URL: z.url().optional(),
    MKETY_HOST_KORA_WEBHOOK_URL: z.url().optional(),
    MKETY_MEDIA_PAYMENT_SETTLEMENT_URL: z.url().optional(),
    MKETY_MEDIA_PAYMENT_SETTLEMENT_SECRET: z.string().min(32).optional(),
    MKETY_HOST_PAYMENT_SETTLEMENT_URL: z.url().optional(),
    MKETY_HOST_PAYMENT_SETTLEMENT_SECRET: z.string().min(32).optional(),
  ...
  runtimeEnv: {
    ...
    FLUTTERWAVE_CHECKOUT_BROKER_SECRET: process.env.FLUTTERWAVE_CHECKOUT_BROKER_SECRET,
    KORA_SECRET_KEY: process.env.KORA_SECRET_KEY,
    MKETY_MEDIA_FLUTTERWAVE_WEBHOOK_URL: process.env.MKETY_MEDIA_FLUTTERWAVE_WEBHOOK_URL,
    ...
    MKETY_MEDIA_PAYMENT_SETTLEMENT_URL: process.env.MKETY_MEDIA_PAYMENT_SETTLEMENT_URL,
    MKETY_MEDIA_PAYMENT_SETTLEMENT_SECRET: process.env.MKETY_MEDIA_PAYMENT_SETTLEMENT_SECRET,
    MKETY_HOST_PAYMENT_SETTLEMENT_URL: process.env.MKETY_HOST_PAYMENT_SETTLEMENT_URL,
    MKETY_HOST_PAYMENT_SETTLEMENT_SECRET: process.env.MKETY_HOST_PAYMENT_SETTLEMENT_SECRET,
