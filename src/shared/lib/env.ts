...
export const env = createEnv({
  server: {
    ...
    // Shared Mkety payment providers. Secrets stay server-side; public keys are
    // passed only to provider-controlled checkout widgets when a payment starts.
    NOWPAYMENTS_API_KEY: z.string().optional(),
    NOWPAYMENTS_IPN_SECRET: z.string().optional(),
    FLUTTERWAVE_PUBLIC_KEY: z.string().optional(),
    FLUTTERWAVE_STANDARD_SECRET_KEY: z.string().optional(),
    FLUTTERWAVE_STANDARD_WEBHOOK_HASH: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    FLUTTERWAVE_STANDARD_SECRET_KEY: process.env.FLUTTERWAVE_STANDARD_SECRET_KEY,
    FLUTTERWAVE_STANDARD_WEBHOOK_HASH: process.env.FLUTTERWAVE_STANDARD_WEBHOOK_HASH,
