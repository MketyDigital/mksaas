...
export const env = createEnv({
  server: {
    ...
    FLUTTERWAVE_API_MODE: z.enum(['v4', 'v3-hosted']).default('v4'),
    FLUTTERWAVE_CLIENT_ID: z.string().optional(),
    FLUTTERWAVE_CLIENT_SECRET: z.string().optional(),
    FLUTTERWAVE_WEBHOOK_SECRET: z.string().optional(),
    FLUTTERWAVE_V3_SECRET_KEY: z.string().optional(),
    FLUTTERWAVE_V3_SECRET_HASH: z.string().optional(),
    FLUTTERWAVE_CHECKOUT_BROKER_SECRET: z.string().min(32).optional(),
    MKETY_FLUTTERWAVE_USD_RATES_JSON: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    FLUTTERWAVE_API_MODE: process.env.FLUTTERWAVE_API_MODE,
    ...
    FLUTTERWAVE_V3_SECRET_HASH: process.env.FLUTTERWAVE_V3_SECRET_HASH,
    FLUTTERWAVE_CHECKOUT_BROKER_SECRET: process.env.FLUTTERWAVE_CHECKOUT_BROKER_SECRET,
    MKETY_FLUTTERWAVE_USD_RATES_JSON: process.env.MKETY_FLUTTERWAVE_USD_RATES_JSON,
