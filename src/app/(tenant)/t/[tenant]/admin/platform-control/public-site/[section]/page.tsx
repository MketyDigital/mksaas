...
const modules: Record<string, PublicSiteModule> = {
  ...
  settings: {
    ...
    description:
      'Manage public brand/SEO, support destinations, and safe Public Mkety AI guidance/fallbacks without changing application source code.',
    items: [
      'Brand name',
      'Logo & favicon',
      'SEO & social image',
