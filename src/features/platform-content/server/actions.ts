...
async function saveSiteSettingsDraft(payload: unknown, actorId: string) {
  ...
  return db.transaction(async (tx) => {
    ...
    const values = {
      ...
      salesEmail: settings.salesEmail ?? null,
      telegramUrl: settings.telegramUrl ?? null,
      publicAssistantFallbackMessage: settings.publicAssistantFallbackMessage ?? null,
      publicAssistantPromptExtension: settings.publicAssistantPromptExtension ?? null,
      publicAssistantLeadCaptureEnabled: settings.publicAssistantLeadCaptureEnabled,
