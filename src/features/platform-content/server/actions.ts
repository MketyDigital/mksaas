...
async function saveSiteSettingsDraft(payload: unknown, actorId: string) {
  ...
  return db.transaction(async (tx) => {
    ...
    const values = {
      ...
      telegramHref: settings.telegramHref ?? null,
      publicAiPrompt: settings.publicAiPrompt ?? null,
      publicAiFallbackMessage: settings.publicAiFallbackMessage ?? null,
      publicAiLeadCaptureEnabled: settings.publicAiLeadCaptureEnabled,
