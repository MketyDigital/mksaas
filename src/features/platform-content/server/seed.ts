...
export async function seedDefaultPlatformContent(): Promise<SeedResult> {
  ...
  if (!existingSettings) {
    await db.insert(platformSiteSettings).values({
      ...
      salesEmail: defaultPlatformSiteSettings.salesEmail,
      telegramHref: defaultPlatformSiteSettings.telegramHref,
      publicAiPrompt: defaultPlatformSiteSettings.publicAiPrompt,
      publicAiFallbackMessage: defaultPlatformSiteSettings.publicAiFallbackMessage,
      publicAiLeadCaptureEnabled: defaultPlatformSiteSettings.publicAiLeadCaptureEnabled,
