    ...
    <>
      {!open ? (
        <button
          ...
          className="mx-auto my-3 flex min-h-12 w-[calc(100%-2rem)] max-w-[720px] items-center gap-3 rounded-2xl border border-violet-400/20 bg-background/90 px-3 py-2.5 text-left shadow-sm backdrop-blur-xl transition hover:-translate-y-0.5 hover:border-violet-400/40 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-400 focus-visible:ring-offset-2"
        >
      ...
      {open ? (
        <section
          ...
          className="fixed inset-x-3 top-[4.75rem] z-[55] mx-auto flex max-h-[min(720px,calc(100vh-6rem))] w-[calc(100%-1.5rem)] max-w-[760px] flex-col overflow-hidden rounded-[1.75rem] border border-violet-400/20 bg-background/96 shadow-2xl shadow-violet-950/20 backdrop-blur-xl supports-[backdrop-filter]:bg-background/88"
        >
          <header className="flex items-center justify-between border-b border-border/80 bg-gradient-to-r from-violet-600/[0.08] to-cyan-500/[0.08] px-4 py-3 sm:px-5">
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0">
                <h2 className="font-semibold">{brandName} AI</h2>
