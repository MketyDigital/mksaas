    ...
    <>
      {!open ? (
        <button
          ...
          className="fixed inset-x-3 top-[4.5rem] z-[55] mx-auto flex min-h-12 w-[calc(100%-1.5rem)] max-w-[560px] items-center gap-2.5 rounded-xl border border-primary/20 bg-transparent px-3 py-2.5 text-left shadow-lg shadow-primary/10 transition hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 sm:top-[4.75rem]"
        >
          <span className="grid h-8 w-8 shrink-0 place-items-center overflow-hidden rounded-lg border bg-transparent shadow-sm">
        ...
        >
          <header className="flex items-center justify-between border-b border-border/80 bg-gradient-to-r from-violet-600/[0.08] to-cyan-500/[0.08] px-4 py-3 sm:px-5">
            <div className="flex min-w-0 items-center gap-3">
              <div className="grid h-10 w-10 shrink-0 place-items-center overflow-hidden rounded-xl border bg-background shadow-sm">
