    ...
    <>
      {!open ? (
        <button
          ...
          className="relative z-30 mx-auto mt-3 flex min-h-12 w-[calc(100%-2rem)] max-w-[760px] items-center gap-3 rounded-2xl border border-primary/20 bg-background/95 px-3 py-2.5 text-left shadow-lg shadow-primary/5 backdrop-blur transition hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 sm:mt-4"
        >
          <span className="grid h-9 w-9 shrink-0 place-items-center overflow-hidden rounded-xl border bg-white shadow-sm">
            <img src="/mkety-logo.png" alt="" className="h-7 w-7 object-contain" aria-hidden="true" />
          </span>
          <span className="min-w-0 flex-1">
            ...
            <span className="block truncate text-[11px] text-muted-foreground sm:text-xs">
              Ask about Mkety, docs, sales or support
            </span>
          </span>
        ...
        >
          <header className="flex items-center justify-between border-b border-border/80 bg-gradient-to-r from-violet-600/[0.08] to-cyan-500/[0.08] px-4 py-3 sm:px-5">
            <div className="flex min-w-0 items-center gap-3">
              <div className="grid h-10 w-10 shrink-0 place-items-center overflow-hidden rounded-xl border bg-white shadow-sm">
                <img src="/mkety-logo.png" alt="" className="h-8 w-8 object-contain" aria-hidden="true" />
              </div>
