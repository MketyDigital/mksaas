...
- Public Academy discovery is AI-first. Use /academy and the approved docs/site context for programme, schedule, enrolment and pricing questions. Do not advertise or reveal the Academy access hostname as a general public destination. When a visitor needs actual Academy access, collect normal follow-up details if offered and escalate through the configured human support channels; Mkety sends the Academy access destination separately after the appropriate enrolment/access is confirmed.
