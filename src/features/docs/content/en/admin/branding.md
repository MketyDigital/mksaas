...
description: Customize your Mkety Platform tenant with colors, typography, density, surface styles, and other visual settings.
section: admin
order: 2
---
...
Mkety Platform is highly customizable to match your organization's visual identity and design preferences. This guide walks through the branding settings available to admins.
...
Customize the three primary colors that define your brand in Mkety Platform:
...
- **WCAG Validation** — When you set a color pair, Mkety Platform automatically checks if it meets Web Content Accessibility Guidelines (WCAG) standards for contrast.
...
- **Default** (1x) — Balanced spacing. Standard Mkety Platform experience.
...
- Use consistent branding across Mkety Platform, email templates, and integrations.

### Accessibility

- Always maintain good contrast (WCAG AA or AAA).
- Use Mkety Platform's built-in contrast validator when picking colors.
...
This will revert all colors, fonts, density, and surface styles to Mkety Platform defaults. Your tenant name and logo remain unchanged.
...
- If the issue persists, contact Mkety Platform support.
...
- **Want more design guidance?** → Contact your Mkety Platform designer or reach out to <support@example.com>

Your brand matters. Take time to get the colors and typography perfect—it's one of the first things people see in Mkety Platform every day.
