...
Mkety Platform organizes the product into **views** and a **sidebar**. This page explains how to move around the app, use global search, and adjust theme and language.
...
Mkety Platform provides **global search** so you can jump to people, docs, or actions without clicking through menus.
...
Mkety Platform can be used in multiple languages (e.g. **English** and **Spanish**).
