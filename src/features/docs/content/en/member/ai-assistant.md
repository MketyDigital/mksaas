...
The **AI Assistant** is Mkety Platform’s conversational interface. You can **chat** in natural language to search for people by skills, get **recommendations**, and ask questions about the platform — without switching to multiple menus or search screens.
...
Phrase your question as you would to a colleague; the assistant will interpret and use Mkety Platform data (skills, people, learning, your profile) to answer.
...
- **Accuracy** — Answers are based on current Mkety Platform data (e.g. assessed skills). If something looks wrong, check the underlying profile or ask an admin.
