...
export const platformControlModules: PlatformControlModule[] = [
  ...
  },
  {
    ...
    description: 'Review non-production deployment requests, approve or reject one-time candidate execution, and inspect deployment history.',
    href: '/admin/platform-control/deployments-domains',
    iconKey: 'cloud',
    level: 3,
    enabled: true,
    ...
    status: 'foundation',
    domain: 'multi-domain',
    editableScope: ['candidate deployment approvals', 'approval review notes', 'request status visibility', 'deployment history'],
    protectedScope: ['production execution', 'DNS mutation', 'custom-domain mutation', 'deployment engine code', 'Cloudflare secrets', 'OCI secrets', 'origin routing internals'],
    implementationNotes: 'Approval authorizes one later customer-triggered isolated candidate execution. Production, DNS, custom domains and rollback remain outside this slice.',
  },
  {
    key: 'domains-routing',
