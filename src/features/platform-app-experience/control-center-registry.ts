...
export const platformControlModules: PlatformControlModule[] = [
  ...
  },
  {
    key: 'payments',
    label: 'Payments',
    description: 'Manage payment-provider business settings, checkout presentation, currencies, and commercial FX pricing.',
    href: '/admin/platform-control/payments',
    iconKey: 'credit-card',
    level: 3,
    enabled: true,
    requiredPermission: 'platform:billing',
    ...
    status: 'active',
    domain: 'multi-domain',
    editableScope: ['commercial FX rates', 'FX markup', 'provider presentation settings', 'payment readiness visibility'],
    protectedScope: ['provider secrets', 'webhook verification', 'settlement rules', 'billing ledger mutation', 'customer-supplied pricing'],
    implementationNotes: 'Business payment configuration is database-backed. Secrets remain runtime-only and settlement remains server-verified.',
  },
  {
